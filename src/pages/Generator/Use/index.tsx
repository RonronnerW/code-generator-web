...
import {getGeneratorVoById, useGenerator} from "@/services/backend/generatorController";
...
const GeneratorUsePage: React.FC = () => {
  ...
  const loadData = async () => {
    ...
    setLoading(true);
    try {
      const res = await getGeneratorVoById({
        //@ts-ignore
        id,
      });
      setData(res.data || {});
          ...
          <Col flex="auto">
            ...
            <Form form={form}>
              {models.map((model, index) => {
                ...
                return (
                  <Form.Item label={model.fieldName} name={model.fieldName} style={{
                    marginLeft: 18,
                    marginRight: 16,
                  }}>
